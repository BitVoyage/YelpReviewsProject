...
if __name__ == "__main__":
    ...
    OUT_FNAME = '/home/zls/Projects/yelp_dataset/high_review_restaurants1.csv'
    ...
    high_review_restaurants = restaurants[restaurants.review_count > NUM_REVIEW_THRESH].copy()
    del restaurants
